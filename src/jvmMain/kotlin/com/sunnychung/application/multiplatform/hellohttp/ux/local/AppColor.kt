...
data class AppColor(
    ...
    val backgroundCancelButton: Color,
...
fun darkColorScheme(): AppColor = AppColor(
    ...
    backgroundCancelButton = Color(red = 0.35f, green = 0.35f, blue = 0.35f),
...
fun lightColorScheme(): AppColor = AppColor(
    ...
    backgroundStopButton = Color(red = 1f, green = 0.47f, blue = 0.47f),
    backgroundCancelButton = Color(red = 0.7f, green = 0.7f, blue = 0.7f),
